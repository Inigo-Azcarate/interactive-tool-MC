...
export class App extends Component {
	constructor(props) {
		...
		this.state = {
		  time: 0,
		  date: 0,
		  animationSpeed: 0.5, //percentage of loopLength
		...
		this.switchTripsData = this.switchTripsData.bind(this);
	...
	switchTripsData() {
		this.setState(prevState => ({
			currentTripsData: prevState.currentTripsData === tripsDataOriginal ? tripsDataCopy : tripsDataOriginal,
		}));
	}
	...
	handleFirstSliderChange(value) {
		...
		// this.setState({
		// 	firstSliderValue: value,
		// 	secondSliderValue: 5, // Valor de origen para el segundo slider
		// 	// No modificamos brtSliderValue, se mantiene
	...
	handleSecondSliderChange(value) {
		...
		// this.setState({
		// 	secondSliderValue: value,
		// 	firstSliderValue: 1, // Valor de origen para el primer slider
		// 	// brtSliderValue se mantiene
		//   }, this.updateDataBasedOnSliders);
	}
	...
	return (
		<div>
			...
			onSwitchTripsData={this.switchTripsData} // Add this line
